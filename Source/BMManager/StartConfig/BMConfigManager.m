...
//        NSData *jData = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"config.native" ofType:@"json"]];
...
+ (void)registerBmModules
{
    NSDictionary *modules = @{
                              ...
                              @"jpushWeexPlugin":   NSStringFromClass([JPushWeexPluginModule class]),
