# coding: utf-8
Pod::Spec.new do |s|
  s.name         = "WeexPluginBaseLibrary"
  s.version      = "1.0.0"
  s.summary      = "Weex iOS App base library"
  s.description  = <<-DESC
                   Weex iOS App base library
                   DESC

  s.homepage     = "https://github.com/clotee/Weex-plugin-ios-baseLibrary"
  s.license      = "MIT"
  s.author       = { "Black Clotee" => "clotee@foxmail.com" }

  s.platform     = :ios, "8.0"
  s.ios.deployment_target = "8.0"
  s.source       = { :git => "https://github.com/clotee/weex-plugin-ios-baseLibrary.git", :tag => s.version.to_s }
  s.requires_arc = true
